...
public interface CourseIndicatorSupportMapper extends BaseMapper<CourseIndicatorSupport> {
    ...
    @Select({
            ...
            "gr.major_id AS majorId, gr.status AS status",
    ...
    @Select({
            ...
            "ip.gr_id AS grId, gr.gr_code AS grCode, gr.gr_description AS grDescription, ip.status AS status",
    ...
    @Select({
            ...
            "gr.gr_id AS grId, gr.gr_code AS grCode, gr.gr_description AS grDescription, gr.major_id AS majorId,",
