...
@Data
@Schema(description = "新增课程-指标点支撑关系请求")
public class AddCourseIndicatorSupportRequest {
    ...
    @Schema(description = "总支撑权重（0~1）", example = "0.40", requiredMode = Schema.RequiredMode.REQUIRED)
