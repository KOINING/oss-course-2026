...
- `deploy/`：部署相关目录，当前预留 Docker Compose、Nginx、环境变量模板和部署说明。
- `docs/`：应用本身的技术文档目录，存放接口约定、模块说明、联调记录、验收记录等。
- `AGENTS.md`：项目级 AI 协作规则说明文件。
- `.codex/skills/README.md`：项目内 AI skill 规划与已落地 skill 说明。

## AI 协作说明

如果使用 AI agent 参与本目录下的开发，建议优先阅读：
...
- `.codex/skills/README.md` 用于记录项目内 skill 与适用场景；repo 内 skill 目录统一维护在 `.codex/skills/` 下。
