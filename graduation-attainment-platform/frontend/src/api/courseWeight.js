...
export function listMajorsForWeightApi() {
    return request.post('/objective-indicator-contributions/listMajors')
}

export function listGradesApi() {
    return request.post('/objective-indicator-contributions/listGradeYears')
}

export function listCoursesForWeightApi(data = {}) {
    return request.post('/objective-indicator-contributions/listCourses', data)
}

export function listIndicatorPointsForWeightApi(data = {}) {
    return request.post('/objective-indicator-contributions/listIndicatorPoints', data)
}
